            ...
            <el-col :sm="24" :lg="12">
                <el-card shadow="hover" class="system-report">
                    ...
                    <div class="report-content">
                        <el-alert title="Keep me where the light is. Keep me where the light is." type="success"> </el-alert>
                        <el-alert title="Keep me where the light is. Keep me where the light is." type="success"> </el-alert>
                        <el-alert title="Keep me where the light is. Keep me where the light is." type="info"> </el-alert>
                        <el-row :gutter="24">
                        ...
                        <el-alert title="Keep me where the light is. Keep me where the light is." type="warning"> </el-alert>
                        <el-alert title="Keep me where the light is. Keep me where the light is." type="error"> </el-alert>
                    </div>
                </el-card>
            </el-col>
            <el-col :sm="24" :lg="12">
...
const chartData = {
    ...
    fpsLegend: ['Battlefield', 'Call Of Duty', 'Counter Strike', 'Splatoon', 'Titanfall']
};
