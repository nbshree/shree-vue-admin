...
export default {
    ...
    beforeDestroy() {
        this.chart && this.autoResize ? window.removeEventListener('resize', this.chartResizeHandle) : null;

        const sidebarElm = document.getElementsByClassName('el-aside')[0];
        sidebarElm ? sidebarElm.removeEventListener('transitionend', this.chartResizeHandle) : null;
